  ...
  void initState() {
    ...
    _blobs = [
      _Blob(
        ...
        accentColor: const Color(0xFF152B5A),
      ...
      _Blob(
        color: const Color(0xFF1B3E7A),
        accentColor: const Color(0xFF2E67B1),
      ...
      _Blob(
        color: const Color(0xFF69C7EA),
        accentColor: const Color(0xFF8EE1F5),
