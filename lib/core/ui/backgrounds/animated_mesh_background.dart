...
class AnimatedMeshBackground extends StatefulWidget {
  const AnimatedMeshBackground({super.key, required this.baseColor});
  ...
  void initState() {
    ...
    _c = AnimationController(
      ...
      duration: const Duration(
        seconds: 10,
      ), // yavaş = daha az dikkat + daha az yük
    );
    _syncAnimation(true);
  }
      ...
      child: RepaintBoundary(
        child: AnimatedBuilder(
          ...
          builder: (context, _) {
            ...
            final p1 = Alignment(-0.75 + 0.25 * cos(t * 2 * pi), -0.8);

            final p2 = Alignment(0.85, -0.2 + 0.25 * sin((t + 0.4) * 2 * pi));

            final p3 = Alignment(-0.2 + 0.25 * sin((t + 0.2) * 2 * pi), 0.95);
